...
function ReleaseLog() {
  ...
  return (
    <Sheet variant="outlined" sx={{ p: 2, minHeight: 200, overflow: 'auto', bgcolor: 'background.level1', mt: 2, borderRadius: 'var(--joy-radius-lg)' }}>
...
function AppInfo() {
  return (
    <Sheet variant="outlined" sx={{ p: 2, minHeight: 120, bgcolor: 'background.level1', borderRadius: 'var(--joy-radius-lg)' }}>

...
// handleOrderClick utility for mobile (if needed, can be customized per requirements)
// Example: set selected order and open details modal
// Usage: handleOrderClick(orderId, rows, setSelectedOrder, setOrderDetailsOpen)
// If not needed, remove this and use inline logic in parent.
